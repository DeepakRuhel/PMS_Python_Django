...
#-------LyoutPage--------
   ...
   path('view_module_category', view_module_category, name='view_module_category'),
   path('view_module',view_module , name='view_module'),
   path('view_Control',view_Control , name='view_Control'),
   path('view_Function',view_Function , name='view_Function'),
   path('view_Stage',view_Stage , name='view_Stage'),
   path('view_Space',view_Space , name='view_Space'),
   path('view_List',view_List , name='view_List'),
   path('view_ListStage',view_ListStage , name='view_ListStage'),
   path('view_ListStageUser',view_ListStageUser , name='view_ListStageUser'),
   path('view_Role',view_Role , name='view_Role'),
   path('view_User',view_User , name='view_User'),
   path('view_Template',view_Template , name='view_Template'),
   path('view_TemplateDetail',view_TemplateDetail , name='view_TemplateDetail'),
