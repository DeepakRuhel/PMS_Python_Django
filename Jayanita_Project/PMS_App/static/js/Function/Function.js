  ...
  function ModuleActionRight(){
    ...
    debugger;
        ...
        if (selectedRowData) {
            ...
            $('#EfunctionName').val(selectedRowData.functionName);
            $('#EinOrder').val(selectedRowData.inOrder);
    ...
    function clearFormFields() {
        ...
        $('#FunctionForm input[type=text], #moduleForm textarea').val('');
        $('#FunctionForm input[type=checkbox]').prop('checked', false);

        // Clear form fields for editing data
        $('#editFunctionForm input[type=text], #EditmoduleForm textarea').val('');
        $('#editFunctionForm input[type=checkbox]').prop('checked', false);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        gridOptions = {
            columnDefs: [
                    { headerName: 'Name', field: 'functionName' },
                    { headerName: 'Sort Order', field: 'inOrder' },
    ...
    function addFunction(e){
        ...
        const payload = {
            "functionName":$('#AfunctionName').val(),
            "inOrder":$('#AinOrder').val(),
    ...
    $('#editFunctionForm').submit(function (e) {
        debugger;
        //Check if the form is valid
        if (!this.checkValidity()) {
            e.preventDefault(); // Prevent form submission if it's not valid
