!function () {
    ...
    function y(e) {
        ...
        document.getElementById("theme-settings-offcanvas") && (
            document.getElementById("sidebar-size") && (document.getElementById("sidebar-size").style.display = "block"),
            document.getElementById("sidebar-view") && (document.getElementById("sidebar-view").style.display = "block"),
            document.getElementById("sidebar-color") && (document.getElementById("sidebar-color").style.display = "block"),
            document.getElementById("sidebar-img") && (document.getElementById("sidebar-img").style.display = "block"),
            document.getElementById("layout-position") && (document.getElementById("layout-position").style.display = "block"),
            document.getElementById("layout-width") && (document.getElementById("layout-width").style.display = "block"),
            document.getElementById("sidebar-visibility") && (document.getElementById("sidebar-visibility").style.display = "none")
        ),
    ...
    function H() {
        Array.from(document.querySelectorAll("#notificationItemsTabContent .tab-pane")).forEach(function (e) {
            0 < e.querySelectorAll(".notification-item").length ? e.querySelector(".view-all") && (e.querySelector(".view-all").style.display = "block") : (e.querySelector(".view-all") && (e.querySelector(".view-all").style.display = "none"),
                e.querySelector(".empty-notification-elem") || (e.innerHTML += '<div class="empty-notification-elem">\t\t\t\t\t\t\t<div class="w-25 w-sm-50 pt-3 mx-auto">\t\t\t\t\t\t\t\t<img src="../images/svg/bell.svg" class="img-fluid" alt="user-pic">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="text-center pb-5 mt-2">\t\t\t\t\t\t\t\t<h6 class="fs-18 fw-semibold lh-base">Hey! You have no any notifications </h6>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>'))
        })
    }
    function P() {
        var e;
