//.....##############################.....module js code........#########################################
 ...
 const ModuleID = urlParams.get('moduleID');
    ...
    debugger;
        ...
        if (selectedRowData) {
            ...
            $('#EModulecategory').val(selectedRowData.moduleCategoryID);
            $('#ECode').val(selectedRowData.code);
            $('#EModuleName').val(selectedRowData.moduleName);
            $('#eddl').val(selectedRowData.moduleIconUrl);
            $('#EroutingLink').val(selectedRowData.routingPage);
            $('#EinOrder').val(selectedRowData.sortOrder);
    ...
    function clearFormFields() {
        ...
        $('#moduleForm input[type=text], #moduleForm textarea').val('');
        $('#moduleForm input[type=checkbox]').prop('checked', false);

        // Clear form fields for editing data
        $('#EditmoduleForm input[type=text], #EditmoduleForm textarea').val('');
        $('#EditmoduleForm input[type=checkbox]').prop('checked', false);
 ...
 // Function to format date to YYYY-MM-DD
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        gridOptions = {
            columnDefs: [
                ...
                { headerName: 'ModuleCategory', field: 'moduleCategoryName' },
                { headerName: 'Name', field: 'moduleName' },
                { headerName: 'Routing Page', field: 'routingPage' },
                { headerName: 'Icon URL', field: 'moduleIconUrl' },
                { headerName: 'SortOrder URL', field: 'sortOrder' },
    ...
    function addModule(e){
        ...
        const payload = {
            "moduleCategoryID":$('#AModulecategory').val(),
            "code":$('#ACode').val(),
            "moduleName": $('#AModuleName').val(),
            "routingPage": $('#AroutingLink').val(),
            "moduleIconUrl": $('#addl').val(),
            "sortOrder": $('#AinOrder').val(),
    ...
    function editModule(e){
        ...
        const payload = {
            ...
            "moduleCategoryID": $('#EModulecategory').val(),
            "code": $('#ECode').val(),
            "moduleName": $('#EModuleName').val(),
            "routingPage": $('#EroutingLink').val(),
            "moduleIconUrl": $('#eddl').val(),
            "sortOrder": $('#EinOrder').val(),
...
// Function to fetch data for the ModuleCategory dropdown
function fetchModuleCategoryDropdown(selectId, selectedCode) {
    debugger;
    // Make an AJAX request to fetch the data from your API
    let options = {
        method: "GET",
...
fetchModuleCategoryDropdown('AModulecategory', null);
fetchModuleCategoryDropdown('EModulecategory', $('#EModulecategory').val());